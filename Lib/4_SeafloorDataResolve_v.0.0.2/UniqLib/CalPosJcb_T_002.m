function [OBSData] = CalPosJcb_T(OBSData,INIData,SVP,MP,MPNum,knots,spdeg)
...
for ShotNum = 1:N_shot
    ...
    [~,t0,gammar0,alfae0,cos_AvgBeta0] = RayJac_Num(Transducer_ENU_ST,MP(index:index+2),PF);
    [~,t1,gammar1,alfae1,cos_AvgBeta1] = RayJac_Num(Transducer_ENU_RT,MP(index:index+2),PF);  
