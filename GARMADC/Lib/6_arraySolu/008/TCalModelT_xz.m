function [MP,MAXLoop2,OBSData] = TCalModelT_xz(soluType,OBSData,INIData,MP,MPNum,knots,spdeg,H)
for MAXLoop2=1:20
    OBSData         =   CalPosJcb_T_xz(soluType,OBSData,INIData,MP,MPNum,knots,spdeg);
    [dX,JCB]              =   CalMPJcb_MTJcb_T_ModelT_xz(OBSData,INIData,MP,MPNum,knots,spdeg,H);
    MP              =	MP  + dX';
