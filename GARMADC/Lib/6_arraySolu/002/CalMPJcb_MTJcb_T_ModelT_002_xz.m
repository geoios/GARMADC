function [dX,JCB] = CalMPJcb_MTJcb_T_ModelT_002_xz(OBSData,INIData,SVP,MP,MPNum,knots,spdeg,H)
...
for ShotNum = 1:N_shot
    ...
    e0 = RayJac_Num(Transducer_ENU_ST,EachPos(index:index+2),PF);
    e1 = RayJac_Num(Transducer_ENU_RT,EachPos(index:index+2),PF);
    
    Jcb(ShotNum,MPNum(1)-2:MPNum(1)) = -(e0 + e1) ./C;
end
