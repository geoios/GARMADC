function [OBSData,INIData,MPArray,MPNum] = Ant_ATD_Transducer(OBSData,INIData,SVP,MP,MPNum,spdeg)
%%
...
%% 基线坐标
INIData.BaseLine.M01_M03 = [863.6298,855.5164,7,4472];
INIData.BaseLine.M03_M04 = [-830.7664,790.1514,6.9745];
INIData.BaseLine.M04_M05 = [-838.5997,-757.5955,4.0742];
INIData.BaseLine.M12_M13 = [819.7301,733.0980,-1.1254];
INIData.BaseLine.M13_M14 = [828.4947,-794.0642,-7.2288];
INIData.BaseLine.M14_M14 = [-855.6903,-1036.5275,-8.6621];
end
