...
[OBSData,SVP,INIData,MP1] = ReadData2Struct_002(OBSFilePath,SVPFilePath,INIFilePath);
...
%3. 瑙ｇ畻
[ModelT_MP_T,ModelT_MAXLoop2,ModelT_MP_T_OBSData] = TCalModelT_002(OBSData,INIData,SVP,MP,MPNum,knots,spdeg,0);
end
