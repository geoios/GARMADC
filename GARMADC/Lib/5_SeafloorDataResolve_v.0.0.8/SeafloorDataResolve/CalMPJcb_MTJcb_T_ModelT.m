function [dX,JCB] = CalMPJcb_MTJcb_T_ModelT(OBSData,INIData,MP,MPNum,knots,spdeg,H)
...
for ShotNum = 1:N_shot
    ...
    e0 = ConstantV_Jcb(Transducer_ENU_ST,MP(index:index+2));
    e1 = ConstantV_Jcb(Transducer_ENU_RT,MP(index:index+2));
    kc0 = OBSData.kc0(ShotNum);
    Jcb(ShotNum,index:index + 2) = -(e0 + e1)*kc0;
end
